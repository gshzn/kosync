...
from kosync_backend.epub import extract_epub_metadata, extract_epub_cover, image_to_base64
...
def get_user_books(
    ...
    for book in books:
        book_dict = {
            ...
            "cover_image_base64": image_to_base64(book.cover_image) if book.cover_image else None
        }
